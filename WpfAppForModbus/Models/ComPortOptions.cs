...
namespace WpfAppForModbus.Models {
    public class ComPortOptions {
        ...
        public bool IsValid() => SelectedParity != null && SelectedStopBits != null && SelectedHandshake != null && SelectedDataBits > -1 && SelectedBaudRate > -1 && !string.IsNullOrEmpty(SelectedPort) && Handler != null;
    }
}
